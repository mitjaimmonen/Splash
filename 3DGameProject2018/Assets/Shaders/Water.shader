    ...
    Properties
		{
			...
			_UScaler("U Scale", Range(0, 10)) = 0.1
			_VScaler("V Scale", Range(0, 10)) = 0.2
        ...
        COMPUTE_EYEDEPTH(o.eyeDepth);
				...
				float phase0 = (_WaveAmp)*sin(0.1 * ((_Time.y * _WaveSpeed) + (v0.x * _WaveOffset) + (v0.z * _WaveOffset)));
				float phase0_1 = (_WaveAmp)*cos(0.1 * (_Time.y * _WaveSpeed) - (v0.x * -_WaveOffset) - (v0.z * -_WaveOffset));
